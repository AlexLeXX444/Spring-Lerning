...
public class HomeWork {
     ...
     * Блок выполнен и даже немного больше.
     * Добавлен Swagger для наглядности. Доступен по ссылке http://localhost:8080/swagger-ui/index.html.
     * Там можно посмотреть и протестировать все созданные ручки.
